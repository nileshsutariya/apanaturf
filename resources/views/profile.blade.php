...
<div class="row">
    <div class="col-lg-9 col-md-10 col-sm-12">
        ...
        <div class="card-footer turffooter">
            <a href="#otp" class="add-banner waves-effect waves-light" data-animation="blur" data-plugin="custommodal"
                data-overlaySpeed="100" data-overlayColor="#36404a">
                <button type="button" class="btn  ml-auto save-btn">Save</button>
            </a>
        </div>
    </div>
</div>
...
<script>
    ...
    function showTab(tabName) {
        ...
        let turfFooter = document.querySelector(".card-footer.turffooter");

        if (tabName == "security") {
            footer.style.display = "none";
            turfFooter.style.display = "block";
        } else {
            footer.style.display = "block";
            turfFooter.style.display = "none";
        }
    }
