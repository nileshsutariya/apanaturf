                            ...
                            <div class="card position-relative">
                                <div class="m-1 box-image">
                                    <div class="row">
                                        <div class="col-12">
                                            @if ($turf->first_image)
                                                <a href="{{ route('bookingturf.product', parameters: $turf->id) }}">
                                                    <img class="card-img-top" src="{{ asset('storage/' . $turf->first_image->image_path) }}" alt="Turf Image" style="object-fit: cover; width: 100%; height: 210px;">
                                                </a>
                                            @else
                                ...
                                <div class="card-body boxcontent ">
                                    <h6 class="m-0 imagname">{{$turf->name}}</h6>
                                    <div class="imgdetails">
                                        <div class="d-flex p-0 mt-1">
                                            ...
                                            <p class="imgcontent mb-0 ml-1 "> {{$turf->location_text}} </p>
                                        </div>
                                        <p class="imgrate mb-0">⭐ 4.5 (200)</p>
                                    </div>
                                    <p class="fw-bold imgprice">${{$turf->booking_price}}/{{$turf->unit}}</p>
                                </div>
                            </div>
                        </div>
                        @endforeach
