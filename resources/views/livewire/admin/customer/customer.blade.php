...
<div class="page-title-box">
    ...
    <div class="d-flex align-items-sm-center flex-sm-row flex-column gap-2">
        ...
        <a href="#add" class="add-transaction waves-effect waves-light" data-animation="blur" data-plugin="custommodal"
                        ...
                        <table id="responsive-datatable" id="walletTable" class="table dt-responsive nowrap"
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h4><span class="badge badge-soft-info pt-2"
                                                    style="border-radius: 30px; font-size: 14px; height: 30px; width: 100px;">User</span>
                                            </h4>
                                        </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div id="walletModal" class="modal-demo modal-lg"
                                            ...
                                            <!-- Available Balance -->
                                            <div class="text-muted px-3 pb-3 mb-2" style="font-size: 12px;">Available
                                                Balance: <span class="fw-bold">₹1000</span></div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h4><span class="badge badge-soft-warning pt-2"
                                                style="border-radius: 30px; font-size: 14px; height: 30px; width: 100px;">Vender</span>
                                        </h4>
                                    </td>
                                    <td style="color: green;">₹400</td>
                                    <td>
