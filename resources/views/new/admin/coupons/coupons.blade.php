...
<div class="modal fade" id="coupons" tabindex="-1" aria-labelledby="couponsTitle" aria-hidden="false">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body mt-3 pt-0 add_coupon">
...
<div class="modal fade" id="couponsview" tabindex="-1" aria-labelledby="couponsTitle" aria-hidden="false">
    <div class="modal-dialog modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="couponsTitle">coupons</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="row">
                <div class="col-sm-12">
            ...
            <div class="modal-body mt-3 pl-5 pt-0">
...
<script>
    ...
    $('#coupons').on('hidden.bs.modal', function () {
        $('#couponsForm').find('input[name="id"], input[name="name"], input[name="phone"], input[name="email"]').val('');
        $('.roletypes').val('');
