    ...
    <div class="container text-center text-md-start mt-5">
        <div class="row mt-3">
            <div class="col-md-3 col-lg-4 col-xl-4 mx-auto mb-4">
                ...
                <div class="">
                    <img src="{{asset('assets/image/users/Image.svg')}}" alt="profile" class="rounded-circle m-1"
            ...
            <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                ...
                <div style="font-size: 11px;">
                    <p>
                        <a href="#" class="fa fa-facebook text-decoration-none" style="color: #e0e0e0;"> 00000000000
                        </a>
                    </p>
                    <p>
                        <a href="#" class="fa fa-twitter text-decoration-none" style="color: #e0e0e0;">
                            Features@gmail.com </a>
                    </p>
                    <p>
                        <a href="#" class="fa fa-instagram text-decoration-none" style="color: #e0e0e0;">
                            abhiguleria@gmail.com </a>
                    </p>
                    <p>
        ...
        <div style="font-size: 12px;">
            <div class="row">
                <div class="col-6 ml-auto text-right">
                    ...
                    <a href="#" class="fa fa-linkedin text-decoration-none " style="color: #e0e0e0;"> User Terms &
                        Conditions | </a>
