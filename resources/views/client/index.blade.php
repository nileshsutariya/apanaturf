...
<script>
    ...
    // Creating a smooth gradient for the shadow effect
    const gradient = ctx.createLinearGradient(0, 0, 0, 400);
    gradient.addColorStop(0, 'rgba(0, 128, 0, 0.3)');  // Green shadow start
    gradient.addColorStop(1, 'rgba(255, 255, 255, 0)');  // Fades to white
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderWidth: 3,
                fill: true,
                backgroundColor: gradient, // Smooth gradient shadow
                pointBackgroundColor: "#ffffff", // White points
                pointBorderColor: "#008000", // Green border for points
                pointBorderWidth: 1, // Green border for points
                pointRadius: 3,
                pointHoverRadius: 4,
        ...
        options: {
            ...
            plugins: {
                ...
                legend: {
                    display: false // Hide default legend for clean look
                }
            },
            scales: {
                x: {
