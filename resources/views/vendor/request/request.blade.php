        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="card mr-3">
                <div class="card-header">
                    <span style="font-size: 15px; color:#878787; font-weight: 600;" class="nameofuser">
                ...
                <hr>
                <div>
                    <p class="m-0" style="font-size: 19px; color:#191919; font-weight:600;">{{$booking->turf->name}}</p>
                    <p style="font-size: 14px; color:#9F9F9F; font-weight:400;">Turf Name</p>
                </div>
                <div>
                    <p class="m-0" style="font-size: 19px; color:#191919; font-weight:600;">{{$booking->booking_on}}</p>
                    <p class="m-0" style="font-size: 19px; color:#191919; font-weight:600;">    
                        {{ \Carbon\Carbon::parse($booking->time_in)->format('g A') }}
                    </p>
