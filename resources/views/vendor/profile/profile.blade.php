...
<form action="{{route('profile.store.vendor')}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-5" style="font-size: 12px;">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" placeholder="Abhishek Guleria" name="owner_name"
                                        style=" letter-spacing: 0.7px; font-size: 12px; border: none;" value="{{$vendor->owner_name}}">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Email</label>
                                    <input type="text" class="form-control" placeholder="abhishekguleria1599@gmail.com" name="owner_email"
                                        style=" letter-spacing: 0.7px; font-size: 12px; border: none;" value="{{$vendor->owner_email}}">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Vender ID</label>
                                    <input type="text" class="form-control" placeholder="098765"
                                        style=" letter-spacing: 0.7px; font-size: 12px; border: none; background: transparent;" value="{{$vendor->vendor_id}}" readonly>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Phone Number</label>
                                    <input type="text" class="form-control" placeholder="1234567890" name="owner_phone"
                                        style=" letter-spacing: 0.7px; font-size: 12px; border: none;" value="{{$vendor->owner_phone}}">
                                </div>
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="d-flex mt-3 mb-5" style="margin-left: 2px;">
                                    <label for="uploadInput"
                                        ...
                                        @if ($vendor->image && $vendor->image->image_path)
                                            <img id="profilePreview" src="{{ asset('storage/' . $vendor->image->image_path) }}"
                                                alt="Profile"
                                        ...
                                        @endif
                                        <input type="file" name="vendor_image" id="uploadInput" style="display: none;">
                                    </label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <button type="submit" class="save-btn ml-3 mt-3">Save</button>
                </div>
            </div>
        </div>
    </div>
